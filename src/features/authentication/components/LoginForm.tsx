...
export function LoginForm() {
  ...
  return (
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6" id="login-form">
      {/* Email */}
      <div>
        <label htmlFor="login-email" className="block text-xs font-display uppercase tracking-widest text-slate-500 dark:text-white/50 mb-2">
          Email Address
        </label>
      ...
      <div>
        <div className="flex items-center justify-between mb-2">
          <label htmlFor="login-password" className="text-xs font-display uppercase tracking-widest text-slate-500 dark:text-white/50">
            Password
          </label>
          <button
            type="button"
